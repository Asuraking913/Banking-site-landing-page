...
function Body1() {
  ...
  return (
    <article>
        <section className='h-screen w-[100%] flex p-[2em] sm:p-0 sm:pl-[4em] screen1'>
            <a href="" className='poppins flex items-center justify-center gap-[0.5em] font-bold capitalize absolute p-[0.7em] top1 sm:p-[1em] px-[1.5em] boxSha rounded-[2em] top-[83%] right-[7%] sm:right-[42%] sm:top-[20%]'><i className='fa-solid fa-car-side text-pink-600 text-2xl'></i>Car loans</a>
            <a href="" className='poppins flex items-center justify-center gap-[0.5em] font-bold capitalize absolute p-[0.7em] sm:p-[1em] px-[1.5em] boxSha rounded-[2em] right-[1em] top-[105px] sm:right-[3%] sm:top-[43%]'><i className='fa-solid fa-house text-pink-600 text-2xl'></i>Home loans</a>
            <div className='w-full h-[100%]  sm:mt-0 mt-[6em] gap-[2.5em] sm:gap-[1.5em] flex flex-col sm:items-start sm:justify-center'>
                ...
                <p className='flex gap-4'>
                    <a href="" className='py-[1em] px-[1.5em] pad1 bg-pink-600 font-semibold text-white rounded-[5px] uppercase'>apply online</a>
                    <a href="" className='py-[1em] px-[1.5em] pad1 border-2 border-pink-600 text-pink-600 uppercase font-semibold rounded-[5px]'>Loan calculator</a>
                </p>
                <div className='sm:flex gap-[1em] items-center bottom1 justify-center absolute bottom-[10%] sm:bottom-0'>
                    <i className='fa-solid fa-phone sm:block inline text-pink-600 text-[1.2rem] text6 '></i>
                    <p className='poppins font-semibold sm:block inline'>+234</p>
                    <p className='poppins font-bold sm:block inline'>|</p>
        ...
        <section className='sm:h-screen screen21 p-[1em] sm:p-[3rem] py-[1em] sm:py-[6rem] flex flex-col items-center justify-center'>
        ...
        <section className='flex justify-center screen21 items-center flex-col sm:h-auto h-[80vh] gap-[0em] sm:gap-[2.5em]'>
        ...
        <section className='flex sm:h-screen h-[80vh] screen3 w-full items-center gap-[4em]'>
        ...
        <section className='sm:p-[3rem] screen1 px-[2em] flex flex-col justify-center items-center gap-[1.5em]'>
        ...
        <section className='h-[100vh] screen4 flex flex-col items-center justify-center py-[2em] px-[1em] sm:p-[3rem] gap-[2em]'>
        ...
        <section className='p-[4rem] flex flex-col screen5 justify-center items-center h-[50vh]'>
            <News />
        </section>
        <Foot />
    </article>
